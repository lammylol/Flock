...
struct PrivacyView: View {
    ...
    var body: some View {
        Menu {
            if person.userID == userHolder.person.userID { // this would mean this is your own profile. You should only be able to set public and private settings for your own prayer requests.
