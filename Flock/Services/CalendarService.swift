...
class CalendarService {
    ...
    func getPrayerCalendarList(userID: String) async throws -> (Date, String) { // This function retrieves calendar prayer list data from Firestore.
    ...
    func updatePrayerCalendarList(userID: String, prayStartDate: Date, prayerList: String) async throws {
