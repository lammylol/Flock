import { useSpeechRecognitionEvent, ExpoSpeechRecognitionModule, AudioEncodingAndroid } from "expo-speech-recognition";
...
export async function transcribeAudioFile(uri: string /* ex. "file:///path/to/audio.wav" */) {
